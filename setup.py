...
if __name__ == '__main__':
    ...
    setup(
        ...
        install_requires=parse_requirements('/home/zhanghao/pycharm_paper/20250327/BRVE-main/requirements/runtime.txt'),
        extras_require={
            'all': parse_requirements('requirements.txt'),
            'tests': parse_requirements('/home/zhanghao/pycharm_paper/20250327/BRVE-main/requirements/tests.txt'),
        },
        zip_safe=False)
